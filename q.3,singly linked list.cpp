/*Question 3 
Write a program to implement singly linked list which supports the following 
operations: (i) Insert an element x at the beginning of the singly linked list
...
singly linked list"<<endl;
 cout<<"3. Remove an element from the beginning of the 
singly linked list"<<endl;
 cout<<"4. Remove an element from ith position in the 
singly linked list."<<endl;
 cout<<"5. Search for an element x in the singly linked 
