Question 5: 
Write a program to implement circularly linked list which supports the following 
operations: 
...
;
 ...
 int choice=1;
 while(choice !=0){
 cout<<"1. Insert an element x at the front of the 
cicularly linked list"<<endl;
 cout<<"2. Insert an element x after an element y in the 
circularly linked list"<<endl;
 cout<<"3. Insert an element x at the back of circularly 
linked list "<<endl;
 cout<<"4. Remove an element from back of the cicularly 
linked list"<<endl;
 cout<<"5. Remove an element from front of the cicularly 
linked list."<<endl;
 cout<<"6. Remove x from the circularly linked list"<<endl;
 cout<<"7. Search for an element x in the cicularly linked 
