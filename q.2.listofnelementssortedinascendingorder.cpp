 Question 2 :
Given a list of N elements, which is sorted in ascending order, you are required to search an
...
element is not present in the list. Assume that the elements of the list are all distinct. Write a
program to perform the desired task.
Solution 2 :
