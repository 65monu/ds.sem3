...
th position in the doubly linked list
(iii) Insert an element x at the end of the doubly linked list 
(iv) Remove an element from the beginning of the doubly linked list (v) Remove 
an element from i
th position in the doubly linked list. 
(vi) Remove an element from the end of the doubly linked list
(vii) Search for an element x in the doubly linked list and return its pointer (viii) 
...
int main() {
 ...
 int choice=1;
 while(choice !=0){
 cout<<"1. Insert an element x at the beginning of the 
doubly linked list"<<endl;
 cout<<"2. Insert an element x at ith position in the 
doubly linked list"<<endl;

 cout<<"3. Insert an element x at the end of doubly linked 
list "<<endl;
 cout<<"4. Remove an element from the beginning of the 
doubly linked list"<<endl;
 cout<<"5. Remove an element from ith position in the 
doubly linked list."<<endl;
 cout<<"6. Remove an element from the end of the doubly 
linked list"<<endl;
 cout<<"7. Search for an element x in the doubly linked 
list and return its pointer"<<endl;
