...
• (iii) Search for an element x in the BST and change its value to y and then 
place the node with value y at its appropriate position in the BST 
• (iv) Display the elements of the BST in preorder, inorder, and postorder 
traversal 
...
int main() {
 ...
 cout<<"3. Search for Element x and replace value y to its 
appropriate position"<<endl;
 cout<<"4. Display the Elements in preorder, inorder and 
postorder transversal"<<endl;
 cout<<"5. Display the elements of BST in level-by-level 
transversal"<<endl;
